...
// 根据环境决定图片资源的URL
const IMAGE_URL = (import.meta.env.MODE === 'development') ? 'https://asset.pptist.cn' : '/mocks'
...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    templates: [
      { name: '红色通用', id: 'template_1', cover: `${IMAGE_URL}/img/template_1.jpg` },
      { name: '蓝色通用', id: 'template_2', cover: `${IMAGE_URL}/img/template_2.jpg` },
      { name: '紫色通用', id: 'template_3', cover: `${IMAGE_URL}/img/template_3.jpg` },
      { name: '莫兰迪配色', id: 'template_4', cover: `${IMAGE_URL}/img/template_4.jpg` },
    ], // 模板
  }),
